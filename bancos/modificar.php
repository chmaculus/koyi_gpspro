...
<td>
<select name="cuenta" >
<option <?php if($array_cuenta=="NG"){echo "selected";} ?> value="NG" >NG</option>
<option <?php if($array_cuenta=="CSM"){echo "selected";} ?> value="CSM" >CSM</option>
<option <?php if($array_cuenta=="COM"){echo "selected";} ?> value="COM" >COM</option>
<option <?php if($array_cuenta=="Efectivo"){echo "selected";} ?> value="Efectivo" >Efectivo</option>
<option <?php if($array_cuenta=="Falso"){echo "selected";} ?> value="Falso" >Falso</option>
